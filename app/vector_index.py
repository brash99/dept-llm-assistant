            ...
            records.append(
                {
                    ...
                    "object_type": item.get("object_type", "document"),
...
def search_index(
    ...
    if fetch_k is None:
        if object_type_filter is None:
            ...
            # A filtered fallback must search deeply enough to find a rare
            # object type while continuing to use the same shared index.
    ...
    for score, idx in zip(scores[0], indices[0]):
        ...
        if (
            ...
            and record.get("object_type", "document")
            != object_type_filter
        ):
            continue
        ...
        results.append(
            RetrievalResult(
                ...
                object_type=record.get("object_type", "document"),
