...
values. Missing credits or enrollment produce an Evidence Fitness limitation;
they are never imputed. The latest complete academic year requires observed fall
