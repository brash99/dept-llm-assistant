...
\item \textbf{Question}:
The user poses a natural-language question.

\vspace{0.05cm}

\item \textbf{Embedding}:
The question is converted into a numerical semantic representation.

\vspace{0.05cm}

\item \textbf{Vector Search}:
The embedding is compared against all document embeddings to locate semantically similar content.

\vspace{0.05cm}

\item \textbf{Top-$k$ Documents}:
The most relevant document chunks are retrieved as supporting evidence.

\vspace{0.05cm}

\item \textbf{Large Language Model}:
The LLM synthesizes an answer using the retrieved evidence.

\vspace{0.05cm}

\item \textbf{Answer}:
A grounded response is returned to the user, ideally with citations.
...
Retrieval-Augmented Generation dramatically improves factual grounding by
allowing the LLM to {\bf reason over retrieved evidence} rather than relying
solely on its internal parameters.

\end{block}

\end{frame}

\begin{frame}{Where is the Engineering?}
...
\begin{block}{Traditional RAG}

Engineering effort focuses on
...
The corpus is largely assumed to already exist.
...
Engineering effort additionally focuses on

\begin{itemize}
\item corpus construction
\item parser validation
\item provenance
\item semantic normalization
\item knowledge objects
\item observatories
\item evidence quality
\item information health
\end{itemize}

\vspace{0.25cm}

The information environment becomes an engineered system.
...
Traditional AI primarily engineers the reasoning engine.

ISO engineers the information environment in which reasoning occurs.
...
\fbox{
\parbox[c][6.5cm][c]{0.95\linewidth}{
\centering
...
\begin{itemize}
\item Unique documents, folders, or types
\item Unique authors, offices, or years
...
\begin{itemize}
\item Mechanical Engineering major vs. Mechanical Engineering program
\item ME degree vs. New undergraduate engineering program
\end{itemize}
...
\begin{frame}{The Institutional Semantic Observatory}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Global semantic ecosystem health
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{frame}{Global Semantic Ecosystem Health}
...
\includegraphics[
    ...
    height=0.82\textheight,
    keepaspectratio
]{iso_semantic_health.jpg}

\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Corpus weaknesses and recommended evidence
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{frame}{Observed Weak Regions and Evidence Gaps}
...
\includegraphics[
    ...
    height=0.82\textheight,
    keepaspectratio
]{iso_semantic_health_evidence.jpg}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Mechanical Engineering decision brief
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{frame}{Decision Support: Mechanical Engineering}
...
\includegraphics[
    ...
    height=0.82\textheight,
    keepaspectratio
]{iso_mechanical_engineering.jpg}
...
catalogs,
planning forms,
and language placement information. {\bf However, the system explicitly reported missing evidence.}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% French decision brief
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{frame}{Epistemic Humility: The French Major}
...
\begin{block}{Institutional Reasoning Pipeline}
