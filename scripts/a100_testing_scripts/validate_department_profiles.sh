...
mkdir -p "$RUN_ROOT"/{workforce,profiles_1,profiles_2}
PYTHONPATH="$PWD" pytest -q scripts/test_department_profiles.py scripts/test_analytical_workforce.py scripts/test_subject_ownership.py scripts/test_institutional_units.py >"$RUN_ROOT/tests.log"
